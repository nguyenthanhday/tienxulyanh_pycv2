...
class Ui_Dialog_Xoay_Anh(object):
    def setupUi(self, Dialog, global_folder_path):
        ...
        self.sl_mucDo.setMinimum(-180)
        self.sl_mucDo.setMaximum(180)
    ...
    def on_slider_moved(self, value):
        ...
        self.value_rotation = value
        self.label_4.setText(f"Góc xoay: {value} độ")
        if os.path.isdir(self.global_folder_path_root):
            files = os.listdir(self.global_folder_path_root)
            ...
            if image_files:
                ...
                # Áp dụng xoay và nghiêng ảnh dựa trên giá trị value
                rotated_img = self.rotate_image(img, value)
    ...
    def handel_locNhieu(self):
        ...
        # Tiếp tục xử lý
        giaTriLoc = self.value_rotation

        if tienIch.xoay_anh(self.global_folder_path_root, self.global_folder_path_save, giaTriLoc):
            QMessageBox.information(None, "Thông báo", "Đã áp dụng xoay ảnh thành công cho các ảnh!")
            self.progressBar.setValue(100)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Dialog"))
        self.label.setText(_translate("Dialog", "<html><head/><body><p>Xoay ảnh</p></body></html>"))
        ...
        self.label_4.setText(_translate("Dialog", "Mức xoay ảnh"))
